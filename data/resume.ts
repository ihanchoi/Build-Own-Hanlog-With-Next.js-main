type tContent = {
    ...
    experience: [
        ...
        content: [
            ...
            tech: ['Typescript', 'TSX', 'Git', 'Github', 'CSS', 'AWS', 'ESLint', 'Prettier'],
        ...
        content: [
            ...
            tech: ['Javascript', 'Express.js', 'HTML', 'CSS', 'Python', 'MSSQL', 'Git'],
    ...
    otherExperience: [
        ...
        content: [
            { title: 'React Analytics Provider', url: 'https://github.com/EveryAnalytics' },
            {
            ...
            {
            title: '기존에 package.json 에 명시된 jest config 를 jest.config.js 로 분리',
